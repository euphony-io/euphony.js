...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Euphony", function() { return Euphony; });
/*
  ...
  euphony.prototype = {
        ...
        case 0:
          ...
          for (let i = 0; i < code.length; i++) {
            ...
            switch (c) {
              ...
              case 'f':
                {
                  const code_idx = parseInt(c, 16); // change hexa to binary
    ...
    setModulation: function (mode) {
      ...
      switch (mode) {
        ...
        case 'cpfsk':
        default:
          // if abnormal mode is inserted, default type is CPFSK.
          T.MODULATION_TYPE = 2;
          break;
      }
    },
    ...
    */
    ...
    maximizeVolume: function () {
      const T = this; // SCAN FOR VOLUME UP
      ...
      switch (T.MODULATION_TYPE) {
        ...
        case 2:
          ...
          switch (T.CHANNEL) {
            ...
            case 1:
            case 2:
              // Channel of CPFSK Modulation is not supported yet.
